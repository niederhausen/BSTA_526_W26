...
![](/images/survey_feedback/bind_rows_add.png){fig-align="center" width=25%}
...
![](/images/survey_feedback/dplyr_join_venn.png){fig-align="center" width=40%}


A more data oriented visual is shown below. The lines denote the keys that match:

![](/images/survey_feedback/joins_colors.png){fig-align="center" width=50%}
