---
title: "Week 6"
pagetitle: "Week 6 BSTA 526"
description: "Start with your goal: more data wrangling"
date: "`r library(here); source(here('schedule_class_dates.R')); w6d1`"
date-modified: "today"
categories: [""]
format: 
  html:
...
-   For today's class, make sure to download to your computer the folder called `part6`. 
...
-   We will first finish the Week 5 slides, starting with [Section 10 on Reshaping data](https://niederhausen.github.io/BSTA_526_W26/part5/part_05_b526.html#reshaping-data).
...
-   None
-   During Week 6 I listed some optional readings here, which I moved to Week 7 since they more closely relate to the Week 7 material.
