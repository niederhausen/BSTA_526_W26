...
We can also customize the layout manually by giving specific input.  Let's get all 5 of our plots involved for these examples.
...
p1 + p2 + p3 + p4 + p5 + guide_area() +
  ...
  plot_annotation(title = 'Morphology of Penguins All 5')
```
